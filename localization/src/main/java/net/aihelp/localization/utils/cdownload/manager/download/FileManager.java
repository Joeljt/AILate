package net.aihelp.localization.utils.cdownload.manager.download;
...
import net.aihelp.localization.utils.cdownload.constants.ConfigConstant;
import net.aihelp.localization.utils.cdownload.entity.CDownloadTaskEntity;
import net.aihelp.localization.utils.cdownload.util.DownloadCheckUtil;
import net.aihelp.localization.utils.cdownload.util.FileUtil;
import net.aihelp.localization.utils.cdownload.util.PathUtil;
...
public class FileManager {
    ...
    public static void startDownload(CDownloadTaskEntity taskEntity) {
        ...
        if (FileUtil.isExist(localFilePath)
                && DownloadCheckUtil.checkFileDownloadOk(taskEntity.getUrl(), localFilePath, needCheckFileLength)) {
            // TODO: 2020/3/10 文件名加时间戳限制，要不然无法更新
